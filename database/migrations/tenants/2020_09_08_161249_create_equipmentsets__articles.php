...
class CreateEquipmentsetsArticles extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('equipmentsets__articles', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
        ...
        Schema::table('equipmentsets__articles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('equipmentsets__articles');
    }
}
