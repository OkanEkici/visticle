...
class CreateCustomerBillingAdressesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer__billing__adresses', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
        ...
        Schema::table('customer__billing__adresses', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('customer_billing_adresses');
    }
}
