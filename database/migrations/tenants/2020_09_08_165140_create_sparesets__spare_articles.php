...
class CreateSparesetsSpareArticles extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sparesets__spare_articles', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
        ...
        Schema::table('sparesets__spare_articles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sparesets__spare_articles');
    }
}
