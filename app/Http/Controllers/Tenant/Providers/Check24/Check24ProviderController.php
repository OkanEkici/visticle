...
namespace App\Http\Controllers\Tenant\Providers\Check24;
...
class Check24ProviderController extends Controller {

    private $menuStructure = [
        'settings' => 'Einstellungen',
        'pricerules' => 'Preisregeln',
        'branches' => 'Lager und Versand',
    ...
    public function getConfigFormArray($provider, $part) {
        ...
        switch($part) {
            ...
            break;
            case 'pricerules':
                $configArray = $this->pricerulesConfigFormArray($provider);
            break;
            case 'branches':
    ...
    protected function pricerulesConfigFormArray($provider) {
        $bulkOptions = [];
