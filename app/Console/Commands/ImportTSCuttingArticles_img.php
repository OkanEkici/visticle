...
class ImportTSCuttingArticles_img extends Command
{
    protected $signature = 'import:tscutting_img';
                            ...
                            { 
                                ...
                                {   if($data[$i] == '') { continue; }
                                    ...
                                    try{
                                        ...
                                        if(!Storage::disk('customers')->exists($thisPath)) 
                                        { $image->delete();$var_image->delete(); echo " [IMG_fail]"; continue; }
                                        ...
                                        $image->delete(); $var_image->delete(); echo " [IMG_fail]";
                                    }
                                }
