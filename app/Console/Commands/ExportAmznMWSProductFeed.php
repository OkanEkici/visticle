...
class ExportAmznMWSProductFeed extends Command
{
    protected $signature = 'export:amazonproductfeed';

    protected $description = 'Exports articles to Amazon MWS as XML file feed.';
    ...
    public function handle()
    {
        ...
        foreach($providers as $provider) {
            ...
            //Send feed to amazon
            $mwsController->sendProductFeed($articles);
        }
        //ARTICLE LOGIC END
    }
}
